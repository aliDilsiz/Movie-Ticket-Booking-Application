...
public class movie extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Kolpacino", "Kutsal Damacana", "Blade Runner 2049", "American Psycho", "Fight Club", "Drive" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CineMaximum", "NostajiCinema", "Akasya", " " }));

        jComboBox3.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "7", "11", "14", "18", "21" }));

        jComboBox4.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "11-11-2022", "12-11-2022", "10-11-2022", "09-11-2022" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String q1=b;
       ...
       PreparedStatement ps;
        String   query = "select tickets from table3 where theatre="+"'"+q1+"'"+" and movie="+"'"+q2+"'";
         try
              {
    ...
    String id1=rs.getString("tickets");
     ...
     ps.executeUpdate("Update table3 set tickets="+id2+" where theatre="+"'"+q1+"'"+" and movie="+"'"+q2+"'");
    }
